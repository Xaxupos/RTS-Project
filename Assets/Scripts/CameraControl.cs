...
public class CameraControl : MonoBehaviour
{
    ...
    void UpdateZoom()
    {
        ...
        rotation.x = Mathf.Lerp(cameraRotationMinMax.y, cameraRotationMinMax.x, zoomLerp) + groundHeight;
    ...
    void TryBuild()
    {
        if(buildingPrefabToSpawn && placer && placer.isActiveAndEnabled && placer.canBuildHere())
        {
            ...
            MoneyEarner.ShowMoneyText(building.transform.position, buyable.cost);
        }
    }
